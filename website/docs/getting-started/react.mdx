...
The active item follows the pointer without a transition; siblings animate to where the solver put them. Keep durations short (120-220ms) and animate `transform` and size only.
