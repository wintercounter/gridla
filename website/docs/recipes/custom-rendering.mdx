...
The React adapter is headless. `GridItem` renders a `div` with geometry and data attributes; everything inside is yours. When even that is too much, the hooks let you position elements however you like.
